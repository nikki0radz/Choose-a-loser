window.addEventListener('DOMContentLoaded',()=>{
  ...
  // settings-extra recolours the base SVG before this file sees it, so matching a
  // hard-coded face colour made the custom eyes fail silently. Match the geometry instead.
  ...
  window.axo=function(requested='auto'){
    ...
    const stroke='#351921';
    if(ex==='love')return swapFace(svg,`<g fill="#ef6378" stroke="${stroke}" stroke-width="4" stroke-linejoin="round"><path d="M110 108 C89 92 91 75 103 75 C110 75 114 81 116 86 C119 81 123 75 130 75 C142 75 144 92 123 108 L116 114 Z" transform="translate(-6 0) scale(.78)"/><path d="M190 108 C169 92 171 75 183 75 C190 75 194 81 196 86 C199 81 203 75 210 75 C222 75 224 92 203 108 L196 114 Z" transform="translate(-6 0) scale(.78)"/></g>`,'<path d="M130 120 Q150 146 170 120 Z" fill="#e76c79" stroke="#351921" stroke-width="5"/>');
    if(ex==='cool')return swapFace(svg,`<g><path d="M91 86 L132 86 L126 108 Q112 116 99 106 Z" fill="#17151a" stroke="${stroke}" stroke-width="4"/><path d="M168 86 L209 86 L201 106 Q188 116 174 108 Z" fill="#17151a" stroke="${stroke}" stroke-width="4"/><path d="M132 91 Q150 84 168 91" fill="none" stroke="${stroke}" stroke-width="5"/><path d="M96 90 L80 85 M204 90 L220 85" stroke="${stroke}" stroke-width="5"/></g>`,'<path d="M134 128 Q150 139 166 126" fill="none" stroke="#351921" stroke-width="5" stroke-linecap="round"/>','<path d="M226 48 L231 58 L242 62 L232 67 L228 78 L223 68 L212 64 L222 59 Z" fill="#ffd75f" stroke="#351921" stroke-width="3"/>');
    ...
    return swapFace(svg,`<g fill="none" stroke="${stroke}" stroke-width="6" stroke-linecap="round"><path d="M98 97 Q110 85 122 97 M178 97 Q190 85 202 97"/></g>`,'<path d="M136 124 Q145 132 140 143 M164 124 Q155 132 160 143 M140 143 Q150 151 160 143" fill="none" stroke="#351921" stroke-width="5" stroke-linecap="round"/>');
  };
