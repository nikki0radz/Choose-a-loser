window.addEventListener('DOMContentLoaded',()=>{
  ...
  window.axo=function(requested='auto'){
    ...
    if(ex==='money')return swapFace(svg,`<g font-family="Arial,sans-serif" font-size="29" font-weight="900" fill="#3a9b55" stroke="${stroke}" stroke-width="1.5" paint-order="stroke"><text x="110" y="106" text-anchor="middle">$</text><text x="190" y="106" text-anchor="middle">$</text></g>`,'<path d="M130 126 Q150 143 170 126" fill="none" stroke="#351921" stroke-width="5" stroke-linecap="round"/>');
