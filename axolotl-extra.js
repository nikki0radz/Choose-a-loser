window.addEventListener('DOMContentLoaded',()=>{
  ...
  window.axo=function(requested='auto'){
    ...
    if(ex==='kiss')return swapFace(svg,`<g><circle cx="110" cy="96" r="12" fill="${stroke}"/><path d="M178 98 Q190 87 202 98" fill="none" stroke="${stroke}" stroke-width="6" stroke-linecap="round"/></g>`,`<g fill="#ef6378" stroke="${stroke}" stroke-width="3" stroke-linejoin="round"><path d="M137 128 Q145 118 150 127 Q155 118 163 128 Q156 137 150 137 Q144 137 137 128Z"/></g>`);
    ...
    if(ex==='star')return swapFace(svg,`<g fill="#ffd75f" stroke="${stroke}" stroke-width="3" stroke-linejoin="round"><polygon points="${star(110,96,17)}"/><polygon points="${star(190,96,17)}"/></g>`,'<path d="M132 125 Q150 146 168 125" fill="none" stroke="#351921" stroke-width="5" stroke-linecap="round"/>');
    if(ex==='angel')return swapFace(svg,`<g fill="none" stroke="${stroke}" stroke-width="5" stroke-linecap="round"><path d="M98 97 Q110 86 122 97 M178 97 Q190 86 202 97"/></g>`,'<path d="M136 126 Q150 137 164 126" fill="none" stroke="#351921" stroke-width="5" stroke-linecap="round"/>','<ellipse cx="150" cy="18" rx="43" ry="11" fill="none" stroke="#ffd75f" stroke-width="6"/><ellipse cx="150" cy="18" rx="32" ry="6" fill="none" stroke="#fff1a8" stroke-width="2"/>');
    if(ex==='money')return swapFace(svg,`<g font-family="Arial,sans-serif" font-size="38" font-weight="900" fill="#3a9b55" stroke="${stroke}" stroke-width="1.8" paint-order="stroke"><text x="110" y="109" text-anchor="middle">$</text><text x="190" y="109" text-anchor="middle">$</text></g>`,'<path d="M130 126 Q150 143 170 126" fill="none" stroke="#351921" stroke-width="5" stroke-linecap="round"/>');
