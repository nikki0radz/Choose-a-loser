  ...
  scene.innerHTML=`
    <svg viewBox="0 0 390 844" preserveAspectRatio="none" aria-hidden="true">
      ...
      <g fill="#0b2852" opacity=".50">
        ...
        <path class="kelp alt" fill="#10345f" opacity=".72" d="M223 844 C210 807 231 776 220 742 C209 707 231 675 221 640 C211 606 233 575 224 541 C216 510 233 482 228 452 C224 429 232 407 231 382 C244 403 242 427 237 448 C231 473 242 496 236 520 C230 546 241 570 235 595 C229 621 239 648 234 674 C228 700 238 728 233 755 C228 782 236 812 235 844 Z"/>
      ...
      <!-- Near kelp: two brightness levels mixed together, including among the tallest strands. -->
      <g fill="#10345f" opacity=".78">
        <!-- One hero strand reaches almost to the top, deliberately using the darker seaweed tone. -->
        <path class="kelp" fill="#0b2852" opacity=".82" d="M56 844 C42 760 70 691 54 614 C39 538 72 470 57 393 C44 321 75 255 61 186 C51 134 68 83 65 25 C88 72 83 125 74 173 C62 228 82 279 71 332 C60 387 79 439 68 494 C58 549 76 606 66 663 C56 720 70 782 68 844 Z"/>
        ...
        <!-- Second tall strand uses the lighter of the two tones, so the tall plants no longer match. -->
        <path class="kelp" fill="#10345f" opacity=".80" d="M304 844 C290 776 315 720 301 658 C287 596 318 540 304 478 C292 420 319 367 308 310 C299 267 316 224 313 177 C333 216 329 261 321 301 C311 347 327 390 317 434 C308 480 324 525 315 571 C306 618 321 666 312 714 C304 763 315 808 313 844 Z"/>
        <path class="kelp alt" fill="#0b2852" opacity=".74" d="M348 844 C339 819 353 796 347 773 C340 749 354 726 348 703 C342 681 353 659 348 637 C343 618 352 599 352 578 C363 596 361 616 357 634 C352 655 361 675 356 696 C351 717 360 738 355 759 C351 781 357 806 356 844 Z"/>
      </g>

      <!-- A few tiny background strands only, leaving most of the screen open. -->
      <g fill="#0b2852" opacity=".44">
        ...
        <path class="kelp alt" fill="#10345f" opacity=".60" d="M263 844 C253 817 269 793 261 768 C253 742 270 718 262 693 C255 670 268 648 267 623 C279 644 277 667 272 688 C267 712 277 734 272 757 C267 781 275 808 274 844 Z"/>
      </g>
      ...
      <g fill="none" stroke="#10345f" stroke-width="1.6" opacity=".40">
